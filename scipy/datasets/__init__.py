...
A registry of all the datasets with their SHA256 hash and repo urls are
maintained, which pooch uses to handle and verify the downloads
...
For Unix::
    ...
    '~/.cache/scipy-data' or the value of the XDG_CACHE_HOME environment variable,
    if defined.
...
In environments with constrained network connectivity for various security reasons
or on systems without continuous internet connections, one may manually
